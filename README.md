...
La dependency da aggiungere anche in tutti i microservizi è:
```sh
<dependency>
...
In questo progetto sono preenti 6 microservices, ognuno con una configurazione diversa.<br  />
